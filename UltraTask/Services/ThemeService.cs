...
{
    public static bool HighlightImportant { get; set; } = false;
    ...
    private record Palette(
        ...
        Color BgSidebar, Color SidebarFg, Color SidebarHover,
        Color BgHeader, Color HeaderFg,
        Color BgRowImportant, Color BgRowImportantHover);
    ...
    private static readonly Palette Dark = new(
        ...
        BgSidebar:             C(0x1F, 0x29, 0x37),
        SidebarFg:             C(0x9C, 0xA3, 0xAF),
        SidebarHover:          C(0x24, 0x30, 0x44),
        BgHeader:              C(0x1F, 0x29, 0x37),
        HeaderFg:              C(0xF9, 0xFA, 0xFB),
        BgRowImportant:        C(0x2A, 0x18, 0x18),
        BgRowImportantHover:   C(0x38, 0x22, 0x22));
    ...
    private static readonly Palette Light = new(
        ...
        Danger:                C(0xEF, 0x44, 0x44),
        ImportantEar:          C(0xDC, 0x26, 0x26),
        BgSidebar:             C(0x0F, 0x4C, 0x75),
        SidebarFg:             C(0xBD, 0xD7, 0xEE),
        SidebarHover:          C(0x1A, 0x60, 0x90),
        BgHeader:              C(0x0A, 0x35, 0x54),
        HeaderFg:              C(0xBD, 0xD7, 0xEE),
        BgRowImportant:        C(0xFF, 0xEE, 0xEE),
        BgRowImportantHover:   C(0xFF, 0xE0, 0xE0));
    ...
    public static void Apply(string theme)
    {
        ...
        SetBrush("BgRowImportant",        HighlightImportant ? p.BgRowImportant      : p.BgRow);
        SetBrush("BgRowImportantHover",   HighlightImportant ? p.BgRowImportantHover : p.BgRowHover);
        SetBrush("BgSidebar",     p.BgSidebar);
        SetBrush("SidebarFg",     p.SidebarFg);
        SetBrush("SidebarHover",  p.SidebarHover);
        SetBrush("BgHeader",      p.BgHeader);
        SetBrush("HeaderFg",      p.HeaderFg);
    }
