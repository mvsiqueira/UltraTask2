...
public class TaskFile
{
    ...
    // Tokens válidos: subtasks, tags, assignee, contact, title, pendencia, notes, spacer, date.
    [JsonPropertyName("task_row_order")]
    public List<string> TaskRowOrder { get; set; } = ["subtasks", "tags", "assignee", "contact", "title", "pendencia", "notes", "spacer", "date"];
